...
/**
 * Includes the content if the jsonotron type is not assigned a label with a given name.
 ...
 */
export function hasNotLabel (this: unknown, context: unknown, options: HelperOptions): string {
