...
/**
 * Includes the content if the jsonotron type is assigned a label with a given name and value.
 ...
 */
export function hasLabelValue (this: unknown, context: unknown, options: HelperOptions): string {
