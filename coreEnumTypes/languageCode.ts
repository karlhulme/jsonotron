...
export const languageCode: EnumType = {
  name: 'languageCode',
  title: 'Language Code',
  paragraphs: [
  ...
  items: [
    ...
    { value: 'en-tt', text: 'English (Trinidad)' },
    ...
    { value: 'mk', text: 'Macedonian (FYROM)' },
    { value: 'ml', text: 'Malayalam' },
    { value: 'ms', text: 'Malaysian' },
    ...
    { value: 'ro-md', text: 'Romanian (Republic of Moldova)' },
    { value: 'ru', text: 'Russian' },
    { value: 'ru-ru', text: 'Russian (Russia)' },
    { value: 'ru-md', text: 'Russian (Republic of Moldova)' },
